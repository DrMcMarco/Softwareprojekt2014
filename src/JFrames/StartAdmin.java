...
public class StartAdmin extends javax.swing.JFrame implements InterfaceMainView {
    ...
    private final String ARTIKEL_AENDERN_EINSTIEG
            = "Artikel ändern Einstieg";
    private final String ARTIKEL_ANZEIGEN_EINSTIEG
            = "Artikel anzeigen Einstieg";

    private final String ZK_AENDERN_EINSTIEG
            = "Zahlungskondition ändern Einstieg";
    private final String ZK_AZEIGEN_EINSTIEG
            = "Zahlungskondition anzeigen Einstieg";

    private final String GP_AENDERN_EINSTIEG
            = "Geschäftspartner ändern Einstieg";
    private final String GP_ANZEIGEN_EINSTIEG
            = "Geschäftspartner anzeigen Einstieg";

    private final String BENUTZER_AENDERN_EINSTIEG
            = "Benutzer ändern Einstieg";
    private final String BENUTZER_ANZEIGEN_EINSTIEG
            = "Benutzer anzeigen Einstieg";
    ...
    private void umsatz_mnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_umsatz_mnActionPerformed
        ...
        this.statistikAnzeige.setzeChart(GUIFactory.getDAO().
                gibChartUmsatzAuftragswert());
    ...
    private void kat_umsatz_mnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kat_umsatz_mnActionPerformed
        this.statistikAnzeige.setzeChart(GUIFactory.getDAO().
                gibChartArtikelkategorieAbsatz());
    ...
    private void umsatz_einkauf_mnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_umsatz_einkauf_mnActionPerformed
        this.statistikAnzeige.setzeChart(GUIFactory.getDAO().
                gibChartUmsatzEinkaufAuftragswert());
