...
import Interfaces.SchnittstelleJTreeFunktionen;
...
public class Hauptmenue_Admin extends javax.swing.JInternalFrame
        implements SchnittstelleJTreeFunktionen {
        ...
        try {
            if (node != null) {// Wird geprüft ob es einen Pfad gibt.
                ...
                if (node.equals("[Navigation, Aufträge verwalten, Auftragskopf, Anlegen]")) {
                    ...
                    this.internal.auftragskopfanlegen.zuruecksetzen();
                ...
                if (node.equals("[Navigation, Benutzer verwalten, Anlegen]")) {
                    ...
                    setzeComponenteSichtbar(this.internal.useranlegen);
                    this.internal.useranlegen.setzeStatusAnlegen();
                }
                ...
                if (node.equals("[Navigation, Benutzer verwalten, Ändern]")) {
                    ...
                    this.internal.useraendern.zuruecksetzen();

                    this.internal.suche.setVisible(false);
                    this.internal.detailSuche.setVisible(false);

                    setzeComponenteSichtbar(this.internal.useraendern);
                }
 ...
 soll und ruft dafür die Methoden des InternalFrames. Sie übergibt sich
    ...
    public void setzeComponenteSichtbar(JInternalFrame frame) {
        ...
        // "setzeComponent"-Methode der Guifactory.
